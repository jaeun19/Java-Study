...
public class FieldTest2 {
	...
	public static void test() { // 프로그램 시작하면서 static에 주소값이 저장됨. static 없으면 값이 저장
		System.out.println("하이");
	}
	
	/*
	 * static 필드 생성시점 : 프로그램 실행과 동시에 메모리의 static영역에 할당된다.(굳이 객체 생성하지 않아도 된다.)
	 * 			 소멸시점 : 프로그램 종료시 소멸된다.
	 * 
