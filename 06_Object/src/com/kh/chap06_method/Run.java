...
public class Run {
	...
	public static void main(String[] args) {
		...
		int a = mt1.method2(); //반환값이 있기 때문에 변수 만들어서 받아옴
		System.out.println("랜덤값은 ?? " + a);
		
		mt1.method3(6, 2); // 반드시 자료형을 맞춰서 매개변수에 대입해야함.
		...
		System.out.println("==================================");
		// static 메소드의 경우에는 new 생성자 구문으로 생성할 필요가 없다.
		...
		MethodTest2.method3("자은", 10);
		//MethodTest2 mt3 = new MethodTest2();
