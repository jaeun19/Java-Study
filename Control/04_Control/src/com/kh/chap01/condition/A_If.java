...
public class A_If {
	 ...
	 * 
	 * 조건문은 크게 if문( 단독 if, if~else, if ~eles if, 중복 if)과 switch문으로 나뉨
	 * 
	 */
	...
	public void method1() {
		...
		public void method3() {
			 ...
			 * if(조건식1) { // 조건식1이 트루라면 실행코드 1을 실행시키고 if블록 종료
			 * //실행코드 1
			 * } else if (조건식 2){ // 조건식2이 트루라면 실행코드2을 실행시키고 if블록 종료
			 * //실행코드 2
			 * } else if (조건식 2){ //조건식3이 트루라면 실행코드3을 실행시키고 if블록 종료
			 * //실행코드 3
		...
		public void method4() {
			...
			String result = ""; // 박스를 먼저 만들어두고 값을 대입하기
			if(age <= 13) {
				result = "어린이";
			} else if(age <= 19) {
				result = "청소년";
		...
		public void method6() {
			...
			//String은 참조자료형 
			//if( name == "김자은") {
				//System.out.println("김자은님반갑습니다");
			//}else {
				//System.out.println("김자은님이 아니시네요 누구신가요?");
			//}
			/*
			 * 기본자료형 : boolean, byte, short, int, long, float, doulbe, char
			 * 참조자료형 : String / 특이함
			 * 
			 * 기본자료형간 비교시 == != 사용가능함
			 ...
			 * 문자열. equals(문자열)
			 */
			if(name.equals("김자은")) { //조건식으로 생각해도 무방함. true or false값을 반환 
				System.out.println("김자은님반갑습니다");
			}else {
				System.out.println("김자은님이 아니시네요 누구신가요?");
			}
