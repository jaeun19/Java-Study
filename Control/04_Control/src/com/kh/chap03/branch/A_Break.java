...
public class A_Break {
	...
	public void method3() {
		// 매번 반복적으로 사용자에게 양수를 입력받아 1부터 사용자가 입력하 수까지 출력
		// 단, 정상적으로 양수를 입력했을 경우 1부터 사용자가 입력한수까지 출력을 한 후 종료
