package com.kh.chap01_poly.party02_electronic.run;

import com.kh.chap01_poly.party02_electronic.controller.ElectronicController1;
import com.kh.chap01_poly.party02_electronic.controller.ElectronicController2;
import com.kh.chap01_poly.party02_electronic.model.vo.Desktop;
import com.kh.chap01_poly.party02_electronic.model.vo.Electronic;
import com.kh.chap01_poly.party02_electronic.model.vo.NoteBook;
import com.kh.chap01_poly.party02_electronic.model.vo.Tablet;
...
//		System.out.println(ec.selectTablet());
		...
		/*
		 * 다형성을 사용하는 이유
		 * 1. 코드를 짧게 쓰기위해서 => 생산성을 위해서
		 * 2. 부모타입의 객체배열로 다양한 자식들을 받아줄수 있음
		 * 		=>부모타입하나만으로 모든 자식객체들을 다룰 수 있음.
		 * 3. 메소드의 매개변수나 반환형에도 다형성을 적용하게되면
		 * 		메소드 갯수가 확 줄어든다.
		 * 
		 */
