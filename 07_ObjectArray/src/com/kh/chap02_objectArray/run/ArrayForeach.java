...
public class ArrayForeach {
	...
	public static void main(String[] args) {
		...
		// 향상된 반복분(for loop)
		/*
		 * for each문(향상된 for문/ 개선된 for문) 배열, 컬랙션과 사용됨 배열 또는 컬렉션의 0번째 인덱스에서부터 마지막 인덱스까지
		 * 순차적으로 접근할 목적일때 사용
		 * 
		 * 초기식 x 조건식 x 증감식 x 반복하는 획수는 ? 배열 또는 컬렉션의 크기. [표현법] for( 순차적으로 접근할 값을 담을 변수 선언
		 * : 배열 / 컬렉션 ){ 실행할 코드 }
		 */
		...
		for (Phone phone : phones) {   // 위에 만들어놓은 Phone 배열에 담아라 
