...
public class A_Variable {
		...
		public void printVariable() {
			...
			// 김갑생 : 00000원 형식으로 출력
			// *은 "곱셈을 의미함
			// 서로 다른 자료형(문자역, 숫자 ..)을 여러개를 하나로 동시에 출력할때는 +로 접합시킨다.
			System.out.println("민경민 : " + (8500 * 6 * 20) + "원");
			System.out.println("민경민2 : " + (8500 * 6 * 20) + "원");
			System.out.println("민경민3 : " + (8500 * 6 * 20) + "원");
			System.out.println("민경민4 : " + (8500 * 6 * 20) + "원");
			System.out.println("민경민5 : " + (8500 * 6 * 25) + "원");
		...
		public void declareVariable() {
			 ...
			 * 
			 * 주의할점
			 * 1. 변수명은 소문자로 시작하게끔 이름 지어줄 것(+낙타등표기법 반드시 지킬것)
			...
			short sNum; // 2byte
			int iNum; // 4byte(-21억 ~ 21억) => 정수형중 대표자료형이고, 리터럴한 정수값이 제시되어 있을 때 해당 값을
			          // 					   int자료형으로 판단한다(기본자료형)
			long lNum; // 8byte
			
			//2_2. 실수형 사이즈에 따라 소수점 아래 더 많은 숫자를 담을 수 있다. 
			float fNum; //4byte => 소수점아래 7자리까지 표현가능
			double dNum; // 8byte => 실수형 중 대표자료형 리터럴한 실수값이 제시되어 있을 때 해당 값을 double자료형으로
			...
			ch = 'A'; //반드시 ''(작은따옴표)안에 넣어줘야한다. 무조건 한글자만. 
...
//			System.out.println(str);
		...
		public void initVariable() {
			 ...
			 */
			//1. 논리형
			boolean isTrue = true; // 1byte  변수선언과 동시에 입력 ->초기화
			...
			int longNum = 999_999_999; //가독성을 위해 _ 사용 
