...
public class C_Cast {
	 ...
	 * 
	 * 컴퓨터의 값 처리 규칙
	 * 1. 대입연산자(=) 기준으로 왼쪽과 오른쪽은 같은 자료형이어야함.
	 ...
	 * 형변환의 종류
	 * 
	 * 1. 자돟형변환(autocasting) : 자동으로 형변환이 진행되기 때문에 내가 직접 형변환할 필요가 없다.
	...
	public void autoCasting() {
		...
		// float는 long자료형보다 담을 수 있는 값의 범위가 더 크기때문.(자동형변환 가능)
		long l5 = 1000000L;
		float f5 = l5;
		 
		System.out.println(f5);
		
		//특이케이스 4. char(2byte) <-> int (4byte) 양방향으로 자동 형변환
		char ch = 65;
	...
	public void forceCasting() {
		...
		// 해결방법 3. 애초에 결과값을 double로 저장하기(데이터 소실 없이 정확한 값이 전달된다)
		double dSum = iNum + dNum; // 14.89
